...
С появлением Go, <strike>стюардессу откопали</strike> параметризованные тесты получили вторую жизнь. Они (google) даже зачем-то придумали свой термин - "табличные тесты". 
